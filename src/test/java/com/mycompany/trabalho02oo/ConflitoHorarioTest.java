...
public class ConflitoHorarioTest {
    ...
    public void testConflitoHorario() {
        ...
        Turma turma2 = sistemaAcademico.cadastrarTurma("MAT102", disciplina2, "Prof. Souza", 30, "Segunda-feira, 14h - 16h");

        try {
            sistemaAcademico.matricularAlunoEmTurma(aluno1, turma1);
            sistemaAcademico.matricularAlunoEmTurma(aluno1, turma2);
            org.junit.Assert.fail("Matricula deveria ter falhado devido a conflito de carga horária.");
